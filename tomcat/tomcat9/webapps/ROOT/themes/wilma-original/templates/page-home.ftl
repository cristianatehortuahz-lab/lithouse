            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <a href="${urls.base}/organizations">
                        <img src="${urls.base}/themes/wilma/images/ImagenMenu/UnidadAcademica.jpg">
                    </a>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <h3>Resultados de investigación </h3>
                    <a href="${urls.base}/research">
                        <img src="${urls.base}/themes/wilma/images/ImagenMenu/ResultadosInvestigacion.jpg">
                    </a>
                </div>
            </div>
        </section>

        <#include "footer_orig.ftl">
