...
<li class="col-lg-3 col-md-6 col-sm-12 hub-person-item" role="listitem" role="navigation" style="min-height: 340px;">
        ...
        <div class="hub-card-img-container" style="min-height: 180px; background: #f8f9fa;">
            <#if (individual.thumbUrl)??>
                <img src="${individual.thumbUrl}" 
                     ...
                     width="270"
                     height="180"
                     style="object-fit: cover; object-position: top; background: #f8f9fa;"
