...
<#assign individualProductExtensionOverView>
    <section id="individualLabOverview">
...
<#assign affiliatedResearchAreas>
    <section id="areasInvestigacion">
        <#include "individual-affiliated-research-areas.ftl">
    </section>
</#assign>

<#assign individualKeyWord>
    <section id="individualLabKeyWord">
        
        <#include "individual-keyWord.ftl">
    </section>
</#assign>

<#assign contactInf>
    <section id="contactInfLab">
    <#--  <#include "individual-contactInfo-2column.ftl">  -->
        <#include "individual-contactInfo.ftl">
    </section>
</#assign>

<#assign placeLaboratory>
    <section id="contactInfLab">
        <#include "individual-place.ftl">
    </section>
</#assign>

<#assign agendaLaboratory>
    <section id="agendaLab">
        <#include "individual-agenda.ftl">
    </section>
</#assign>
...
<#assign individualProductExtension>
    ...
    <#--  <section id="servicioVocavulary">
        <#include "individual-vocabularyService.ftl">
    </section>  -->
    <section id="paginaWEB">
...
<#include "individual-vitro-lab.ftl">
...
${stylesheets.add('<link rel="stylesheet" href="${urls.base}/css/individual/individual.css" />',
                  ...
                  '<link rel="stylesheet" href="${urls.base}/themes/wilma/css/individual-vivo-lab.css" />',
