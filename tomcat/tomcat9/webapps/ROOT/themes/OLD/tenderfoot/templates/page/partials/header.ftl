<header  id="branding" role="banner">
    ...
    <h1 class="logo-ur">
        <a title="${i18n().identity_title}" href="https://urosario.edu.co/" target="_blank">
            <img class="header-icon" src="${urls.base}/themes/wilma/images/VIVO-logo.png" alt="">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                     ...
                     <#if isHomePage?? && isHomePage>
                        <#--  //do nothing  -->
                     <#else>
                        <form class="nav-search-form d-flex" role="search" action="${urls.search}" method="GET">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                if (window.location.pathname === "/" || window.location.pathname.includes("home")) {
                    const elemento = document.querySelector(".nav-search-form");
                    if (elemento) {
