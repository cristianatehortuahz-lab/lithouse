...
<div class="contentsBrowseGroup clear clearfix">
     ...
     <div class="search_partner">
       ...
       <form id="search-partner" class="js-search-form" action="${urls.base}/find-a-partner" method="GET">
		...
		<div class="search_partner-box">
            <h4 class="search_partner-title">Find a Research Partner</h4>
            <input type="text" id="facets-querytext"  name="querytext" autocomplete="off" class="search_partner-input-w100 js-query-text" value="${querytext}"/>
        ...
        <script type="text/javascript"> var urlBaseForFilterSearch = '${urls.base}' + '/find-a-partner' </script>
  ...
  <div class="search_results js-results-container">
    ...
    <div class="search_partner-box sort-search-box">
      <h4 class="search_partner-title">Sort by:</h4>
      <select id="sort" name="sort" class="search_partner-input-w100 search_partner-select js-search">
        ...
        <#else>
          <option value="nameLowercaseSingleValued|ASC">Alphabetical (A-Z)</option>
			...
			<#-- Ordenar por numero de grants y de publicaciones JCCJ -->
			<#if sort?? && sort == "numPublications|DESC">
			   <option value="numPublications|DESC" selected>Relevance (No. Publications)</option>
			<#else>
			   <option value="numPublications|DESC">Relevance (No. Publications)</option>
			</#if>
			
			 <#if sort?? && sort == "numGrants|DESC">
			   <option value="numGrants|DESC" selected>Relevance (No. Grants)</option>
			<#else>
			   <option value="numGrants|DESC">Relevance (No. Grants)</option>
			</#if>
			<#-- Ordenar por numero de grants y de publicaciones JCCJ -->
