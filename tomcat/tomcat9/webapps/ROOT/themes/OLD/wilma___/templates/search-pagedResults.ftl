...
<div class="search-results-header-box clearfix">
...
</div> <#-- end search-results-header-box -->

<div class="contentsBrowseGroup clearfix clear">
   <div class="contentsBrowseGroup-top-box clearfix">

      <div class="searchTOC-box">
        <#-- Refinement links -->
        <h2>pruebasTOC</h2>
        <#if classGroupLinks?has_content>
            <h2>pruebasDisplayTOC</h2>
            <div class="searchTOC">
      ...
      <#-- Search results -->
      <ul class="searchhits" id="searchhits-id">
  ...
  <div class="contentsBrowseGroup-bot-box clearfix">
    <#-- Paging controls -->
