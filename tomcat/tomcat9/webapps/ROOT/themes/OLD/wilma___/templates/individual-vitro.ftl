...
<div class="organizationInf">
    ...
    <section id="individual-intro" class="vcard clearfix" role="region" <@mf.sectionSchema individual/>>
        ...
        <section id="individual-infoOrga" ${infoClass!} role="region">
            <section id="share-contact" role="region">
                ...
                <section id="photoOrganization">${individualImage}</section>
        ...
        <section id="left-colum">           
            <section id="menufiltro">
                ...
                -->
                <#include "individual-property-group-tabs-perf-facultad.ftl">
            </section>
