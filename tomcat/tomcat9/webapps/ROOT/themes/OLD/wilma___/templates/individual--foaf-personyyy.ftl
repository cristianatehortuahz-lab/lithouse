...
<section id="individual-intro" class="vcard person" role="region">
    ...
    <section id="individual-info" ${infoClass!} role="region">
        ...
        <section id="presentacion" role="region">
            ...
            <section id="infperfil" role="region">
                <!-- Image -->
            ...
            <section id="AreaInvestiga" role="region">
                    <!-- Research Areas -->
                ...
                <#--  incluye position  -->
                <#--  <#include "propStatement-personInPosition.ftl">  -->
                <#include "individual-affiliated-research-areas.ftl">
            </section>
        </section>

        <section id="InformacionDatos">
            ...
            <#list propertyGroups.all as group>
                <#if (group.properties?size > 0)>
                    ...
                    <section id="${groupNameHtmlId?replace("/","-")}" class="property-group" role="region" style="<#if (sectionCount > 1) >display:none<#else>display:block</#if>">
                        ...
                        <#--  <se incluye elementos de pestañas "individual-properties.ftl"  -->
