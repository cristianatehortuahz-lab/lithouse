	  ...
	  <div class="shortview_person-data">
		<div class="person-header">
			<div class="col-md-12 col-xs-12 text-left">
				...
				<#if (depart[0].div)?? >
				     <span class="title"><a id="blankItem" class="black-text" href="${depart[0].fac}" target="_blank">${depart[0].div}</a></span>
				<#elseif (depart[0].org)?? >
				     <span class="title"><a id="blankItem" class="black-text" href="${depart[0].fac}" target="_blank">${depart[0].org}</a></span>
				<#elseif (depart[0].grp)?? >
				     <span class="title"><a id="blankItem" class="black-text" href="${depart[0].fac}" target="_blank">${depart[0].grp}</a></span>
				</#if>
