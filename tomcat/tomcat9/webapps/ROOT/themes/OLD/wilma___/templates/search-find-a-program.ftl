...
<div class="contentsBrowseGroup clear clearfix">
    ...
    <#if facets?has_content>
     <div class="search_supervisor">
       ...
       <form id="search-supervisor" class="js-search-form" action="${urls.base}/find-a-program" method="GET">
         ...
         <div class="search_supervisor-box">
            <h4 class="search_supervisor-title">Find a Degree</h4>
            ...
            <#if searchBy?? && searchBy == "name">
              <label class="search_supervisor-label hidden" for="searchByName">
        ...
        ${scripts.add('<script type="text/javascript" src="${urls.base}/themes/wilma/js/dynamic-filters2.js"></script>')}
        <script type="text/javascript"> var urlBaseForFilterSearch = '${urls.base}' + '/find-a-program' </script>
...
search_vivo[0].value= "";
  ...
  <div class="search_results js-results-container">
   ...
   <#-- Paging controls -->
    ...
    <ul class="searchhits js-search-hits">
