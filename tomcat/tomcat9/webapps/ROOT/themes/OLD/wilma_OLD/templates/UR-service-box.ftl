	...
	<div class="row d-flex">
		<div class="col-lg-3 col-md-6 col-sm-12">
			<div class="card h-100" id="service-box">
				<img src="./themes/wilma/images/servicios/s1_new.jpg" class="card-img-top" alt="Servicio1">
		...
		<div class="col-lg-3 col-md-6 col-sm-12">
			<div class="card h-100" id="service-box2">
				<img src="./themes/wilma/images/servicios/s2_new.jpg" class="card-img-top" alt="Servicio2">
				<div class="card-body" id="box-message">
					<p class="card-text">
						${i18n().find_partner}
					</p>
		...
		<div class="col-lg-3 col-md-6 col-sm-12">
			<div class="card h-100" id="service-box3">
				<img src="./themes/wilma/images/servicios/s3_new.jpg" class="card-img-top" alt="Servicio3">
				<div class="card-body" id="box-message">
					<p class="card-text">
						${i18n().find_degree}
					</p>
		...
		<div class="col-lg-3 col-md-6 col-sm-12">
			<div class="card h-100" id="service-box5">
				<img src="./themes/wilma/images/servicios/s5.jpg" class="card-img-top" alt="Servicio5">
				<div class="card-body" id="box-message">
					<p class="card-text">
						${i18n().find_lab}
					</p>
