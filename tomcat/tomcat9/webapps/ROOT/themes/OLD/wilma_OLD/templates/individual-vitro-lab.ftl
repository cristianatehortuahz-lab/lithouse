...
<div class="organizationInfLab">
    ...
    <section id="individual-intro-Lab" class="vcard clearfix" role="region" <@mf.sectionSchema individual/>>
        ...
        <section id="information">
            ...
            <button id="agendar" class="buttonAgenda"name="agendaEspacio"><a href="http://10.194.194.11/A48/salas/index.php?view=week&view_all=0&page_date=&area=4&room=18">AGENDAR</a></button>
