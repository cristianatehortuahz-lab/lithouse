var dFilter = {
  ...
  //Carga todos los query correspondiente a la pagina
  el: {
    form: document.querySelector('.js-search-form'),
    //queryTextInput: document.querySelector('.js-query-text'),
    queryTextInput: document.querySelector('#facets-querytext'),
    inputsOutOfForm: {
  ...
  newSearch: function(queryObj) {
    ...
    $.ajax({
	  url: `${self.urlBase}?json=1&classgroup=http%3A%2F%2Fvivoweb.org%2Fontology%23vitroClassGrouppeople`,
      data: queryObj,
...
//Consultas APR
//console.log(urlBaseForFilterSearchurlBaseForFilterSearch);  //pagina de consulta
//console.log(window.location.toString()); //url completa con condiciones de input
console.log("consultaText");
console.log(ulResultsParent.value);
console.log(queryTextInput.value);
