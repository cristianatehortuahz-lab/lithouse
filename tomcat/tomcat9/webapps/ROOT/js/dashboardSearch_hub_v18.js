...
document.addEventListener("DOMContentLoaded", function () {
    ...
    async function loadCategory(key) {
        ...
        try {
            const cacheKey = 'hub_v8_' + btoa(unescape(encodeURIComponent(cfg.url)));
            ...
            console.log(`[HUB Debug] Key: ${key}, Limit: ${limit}, Relevant Data Length: ${relevant.length}, Expanded: ${isExpanded}`);
